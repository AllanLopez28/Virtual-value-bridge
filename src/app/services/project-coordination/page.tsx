...
export default function ProjectCoordinationPage() {
  const responsibilities = [
    "Keeping project boards current in Asana, ClickUp, or Monday — dates, owners, dependencies",
    "Breaking high-level goals into clear tasks and subtasks with owners",
    "Tracking completion daily and following up on overdue deliverables",
    "Vendor and contractor coordination: briefs, timelines, and check-ins",
    "Scheduling check-ins and preparing focused agendas that drive decisions",
    "Taking meeting notes and logging action items — who does what by when",
    "Flagging blockers and risks early, before they turn into missed deadlines",
    "Weekly status reports on progress, risks, and what needs a decision from you",
    "Organizing documentation, shared folders, and version control for SOWs and briefs",
    "Keeping one single source of truth accurate as of the end of each day",
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-sm font-medium mb-6">
                ...
                <span className="text-slate-900">Project Coordination</span>
              </div>

              {/* Title */}
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight mb-6 tracking-tight">
                Meet Your <br />
                <span className="text-blue-600 italic">Project<br />Coordination<br />Specialist</span>
              </h1>

              {/* Paragraph */}
              <p className="text-lg text-slate-700 max-w-xl leading-relaxed mb-8">
                Projects stall when no one is chasing the details. Get a dedicated project coordinator who keeps your boards up to date, follows up on every deliverable, coordinates your vendors, and flags blockers before they turn into missed deadlines.
              </p>
            ...
            <div className="flex justify-center lg:justify-end relative mt-8 lg:mt-0">
              <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full bg-white shadow-xl flex items-center justify-center p-2">
                <div className="relative w-full h-full rounded-full overflow-hidden bg-blue-50/50">
                  <Image
                    src="/andres.png"
                    alt="Project Coordination Specialist"
                    fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-16">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-8 tracking-tight">
                What Your Project Coordinator Handles
              </h2>
              ...
              <div className="mb-12">
                ...
                <div className="flex items-center gap-4 p-5 border border-gray-200 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base font-bold text-slate-900 truncate">Andrés</h3>
                    <p className="text-sm text-slate-500 line-clamp-2">
                      Project Coordination, Task Tracking, Vendor Coordination & Reporting
                    </p>
                  </div>
