...
export default function PropertyManagementPage() {
  const responsibilities = [
    "Tenant communication, leasing inquiries, and move-in / move-out coordination",
    "Maintenance request triage and vendor coordination",
    "Rent collection follow-ups and delinquency tracking",
    "Owner reporting and monthly statements",
    "Property listing updates and vacancy management",
    "Data entry and record-keeping inside your property management software",
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-sm font-medium mb-6">
                ...
                <span className="text-slate-900">Property Management Specialist</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight mb-6 tracking-tight">
                ...
                <span className="text-blue-600 italic">Property Management Specialist</span>
              </h1>
