                ...
                <div className="grid grid-cols-2 gap-3">
                  {tools.map((tool, idx) => (
                    <div key={idx} className="bg-white border border-slate-200 rounded-xl p-3 flex items-center gap-3 shadow-sm hover:border-slate-300 hover:bg-slate-50 transition-colors">
                      <div className="w-6 h-6 rounded border border-slate-200 bg-slate-100 shrink-0 flex items-center justify-center">
                        <div className="w-2.5 h-2.5 bg-slate-300 rounded-sm"></div>
                      </div>
                      <span className="text-[13px] font-bold text-slate-700 truncate">{tool}</span>
                    </div>
                  ))}
                </div>
              </div>
