...
export default function DataEntryBackOfficePage() {
  const responsibilities = [
    "Accurate data entry into spreadsheets, CRMs, and internal databases",
    "Data cleaning: deduplication, format standardizing, and fixing bad records",
    "Validation against source documents with a second-pass QA review",
    "Order processing: entering, updating, and tracking orders end to end",
    "Invoice, receipt, and purchase-order processing, filing, and matching",
    "Document digitization and transcription into clean, searchable files",
    "Web research to collect, verify, and compile data points and lists",
    "Product catalog and inventory updates for your e-commerce listings",
    "Report prep and recurring summaries built from your raw data",
    "Flagging anomalies instead of entering bad data, and building reusable templates",
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="text-sm font-medium mb-6">
                ...
                <span className="text-slate-900">Data Entry & Back-Office</span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight mb-6 tracking-tight">
                ...
                <span className="text-blue-600 italic">Data Entry & Back-<br className="hidden sm:block" />Office Specialist</span>
              </h1>

              {/* Paragraph */}
              <p className="text-lg text-slate-700 max-w-xl leading-relaxed mb-8">
                Back-office work piles up fast when no one owns it. Get a dedicated data & back-office specialist who keeps your records clean, processes your orders, runs the research, and turns raw data into reports you can actually use — accurately and on a schedule you can count on.
              </p>
            ...
            <div className="flex justify-center lg:justify-end relative mt-8 lg:mt-0">
              <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full bg-white shadow-xl flex items-center justify-center p-2">
                <div className="relative w-full h-full rounded-full overflow-hidden bg-blue-50/50">
                  <Image
                    src="/sofia3.png"
                    alt="Data Entry & Back-Office Specialist"
                    fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-16">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-8 tracking-tight">
                What Your Data & Back-Office Specialist Handles
              </h2>
              ...
              <div className="mb-12">
                ...
                <div className="flex items-center gap-4 p-5 border border-gray-200 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base font-bold text-slate-900 truncate">Sofia</h3>
                    <p className="text-sm text-slate-500 truncate">
                      Data Entry, Order Processing, Research & Reporting
                    </p>
                  </div>
