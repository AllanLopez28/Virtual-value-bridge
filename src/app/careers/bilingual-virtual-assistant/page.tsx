...
export default function BilingualVirtualAssistantPage() {
    ...
    <main className="min-h-screen bg-slate-50 w-full flex flex-col items-center">
      ...
      <section className="w-full bg-gradient-to-b from-sky-50 to-white pt-24 pb-32 px-4 md:px-6 flex flex-col items-center text-center">
        <p className="text-xs font-bold text-slate-500 tracking-widest uppercase mb-6">
          SUPPORT &bull; SAN SALVADOR, EL SALVADOR &bull; FULL-TIME
        </p>
        ...
        <p className="text-lg text-slate-500 max-w-2xl leading-relaxed mb-10">
          Are you a master of organization, an excellent communicator in English, and ready to support high-level US teams? This opportunity is for you!
        </p>
        <button
        ...
        <div className="bg-white rounded-xl shadow-md border border-slate-100 p-6 md:p-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-left">
            <div>
              ...
              <p className="text-sm md:text-base font-bold text-[#0B132B]">Support</p>
            </div>
            <div>
              <p className="text-xs text-slate-500 font-semibold mb-1">Location</p>
              <p className="text-sm md:text-base font-bold text-[#0B132B]">San Salvador, El Salvador (Remote)</p>
            </div>
            <div>
          ...
          <div className="flex flex-col gap-10">
            <div>
              ...
              <ul className="flex flex-col gap-4">
                {[
                  "You have previous experience as a Virtual Assistant, Administrative Assistant, or in a highly demanding support role.",
                  "You are fully bilingual (English/Spanish) with exceptional written and verbal communication skills.",
                  "You are highly proficient in tools like Google Workspace, Microsoft Office, Slack, and Zoom.",
                  "You excel at multitasking, prioritizing daily workloads, and managing time efficiently without micro-management.",
                  "You are highly proactive, detail-oriented, and capable of working independently in a fully remote environment.",
                ].map((item, idx) => (
            ...
            <div>
              ...
              <ul className="flex flex-col gap-4">
                {[
                  "Manage complex calendars, schedule meetings, and coordinate appointments seamlessly across different US time zones.",
                  "Handle email inbox management, drafting professional responses, and organizing daily communications.",
                  "Perform data entry, document preparation, spreadsheet management, and targeted web research.",
                  "Act as a reliable, professional point of contact for internal team members and external clients.",
                ].map((item, idx) => (
                  <li key={idx} className="flex gap-4">
      ...
      <JobApplicationModal
        ...
        jobTitle="Bilingual Virtual Assistant"
      />
    </main>
  );
}
